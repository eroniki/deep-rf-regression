...
class wifi_data(object):
    ...
    def __init__(self, folder_location, filename, normalize, nTraining, nTesting, nValidation, verbose=False, missingValues=0):
        ...
        = self.extract_data_from_container(self.__data_container__)
        ...
        self.__lora_data__, self.__grid_labels_by_xy__, self.__grid_labels_by_number__)
    ...
    def extract_data_from_container(self, container):
        ...
        return grid_labels, grid_labels_linear, data_wifi, data_bt, data_lora

    def split_data(self, wifi_data, bt_data, lora_data, grid_labels_by_xy, grid_labels_by_number):
        ...
        grid_labels_by_number_train, grid_labels_by_number_test, grid_labels_by_number_valid
